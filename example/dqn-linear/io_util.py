...
def show_info( info, cv_img, direction):
    ...
    cv2.putText(cv_img, 'Reward:' + str(round(info['Reward'], 3)), (220, 450), font, 0.5, (255, 255, 255), 2)
    #cv2.putText(cv_img, 'Velocity:' + str(info['Action'][0]), (500, 430), font, 0.5, (255, 255, 255), 2)
    cv2.putText(cv_img, 'Dir_pre:' + str(direction), (500, 450), font, 0.5, (255, 255, 255), 2)
    cv2.putText(cv_img, 'Dir_truth:' + str(((info['Direction']+180)%360)/360.0), (500, 430), font, 0.5, (255, 255, 255), 2)
