...
class Memory:
    ...
    def getMiniBatch(self, size) :
        ...
        for index in indices:
            ...
            if index == 0 or self.finals[index-1] == True:
                motion_batch.append([0,0])
            else:
                motion_batch.append(self.actions[index-1][:2])

        #print action_batch

        return state_batch, action_batch, reward_batch, newState_batch, isFinal_batch, motion_batch