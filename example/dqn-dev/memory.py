...
class Memory:
    ...
    def addMemory(self, state, action, reward, newState, isFinal, angle):
        ...
        if (len(self.states) > self.size):
            ...
            self.angles[self.currentPosition] = angle
        else:
    ...
    def getMiniBatch(self, size):
        ...
        for index in indices:
            ...
            angles_batch.append(self.angles[index])

        return state_batch, action_batch, reward_batch, newState_batch, isFinal_batch, angles_batch